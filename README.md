...
📖 [HTML CSS Java Script](https://basicweb.ru/) [**EN**] –  справочники.
...
📖 [Pug(Jade)](https://gist.github.com/neretin-trike/53aff5afb76153f050c958b82abd9228) [**RU**] –  Туториал по CSS препроцессору Pug(Jade).

📖 [Гайды по верстке](https://guides.kontur.ru/) [**RU**] –  Дизайн и Интерфейсы Контур.
...
# Справочники по консольным командам Git
...
* [How to mock data in React with a fake API](https://www.robinwieruch.de/react-mock-data) [**EN**], Как имитировать данные в React с помощью поддельного API.
...
* [Как использовать Reducer](https://www.robinwieruch.de/react-usereducer-hook/) [**EN**], в React?
...
📖 [SitepointBlog](https://www.sitepoint.com/blog/) [**EN**] –  В блоге публикуют статьи о программировании, вёрстке, дизайне, UX. Статьи выходят несколько раз в неделю.

📖 [Netflix Tech Blog](https://medium.com/netflix-techblog) [**EN**] –  В блоге компании Netflix регулярно выходят полезные статьи о программировании. Разработчики компании делятся своим опытом и полезными лайфхаками.Приложение пишут на React.
